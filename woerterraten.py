...
saetze = [ "Alte Liebe rostet nicht.",
...
"An ihren Taten sollt ihr sie erkennen. - ''sprichwörtlich nach der Bibel Matthäus 720''",
...
"Auf seinem Misthaufen ist der Hahn (Tier)|Hahn König (Monarch)|König. - ''nach Publilius Syrus''",
...
"Aushorcher und Denunziant|Angeber sind Teufels Netzeweber.",
...
"Bei Wolf (Tier)|Wölfen und Eulen // Lernt man heulen.",
...
"Braun (Farbe)|Braune Augen sind gefährlich aber in der Liebe ehrlich.",
...
"Das Auge ist ein Fenster in die Seele. - ''angelehnt an die Bibel Matthäus 622; dort: Das Auge ist des Leibes Licht''",
...
"Der Glaube kann Berge versetzen. - ''sprichwörtlich nach der Bibel 1. Korinther 132''",
...
"Der Mensch lebt nicht vom Brot allein. - ''sprichwörtlich nach der Bibel Matthäus 44''",
...
"Die Frauen|Frau ist des Männer|Mannes Visitenkarte.",
...
"Die Letzten werden die Ersten sein! - ''sprichwörtlich nach der Bibel Matthäus 1930 und 2016 Markus 1031 Lukas 1330''",
...
"Einem Nacktheit|nackten Mann kann man nicht in die Taschen greifen.",
"Einen alten Baum verpflanzt man nicht.",
"Einer der schreit hat schon verloren.",
"Einer spinnt immer.",
":*Nachsatz: … wenn zwei spinnen wird's schlimmer.",
"Einer trage des anderen Last. - ''sprichwörtlich nach der Bibel Galater 62''",
...
"",
"== G ==",
"Geben ist seliger denn nehmen. - ''sprichwörtlich nach der Bibel Apostelgeschichte 2035''",
...
"Immer bleibt der Affe ein Affe - werd' er selbst König (Monarch)|König oder Pfaffe.",
...
"Schlechter Umgang verdirbt gute Sitten. - ''sprichwörtlich nach der Bibel 1. Korinther 1533''",
...
"Traum|Träum' süß von sauren Gurken.",
"Träume sind Schäume",
...
zahlen={" null ": 0, " eins ": 1, " zwei ": 2, " drei ": 3, " vier ": 4, " fünf ": 5,
...
for i in range(10):
  for satz in saetze:
    ...
    for wort in satz.split():
      if wort in zahlen.keys():
        wort = str(zahlen[wort])
      codewort += wort[0]
    print "".join(codewort)
